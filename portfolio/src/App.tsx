...
const aboutData = {
  description: 'עם ניסיון עשיר בפיתוח, ניהול והובלת תהליכי הדרכה, אני משלב בין הבנה עמוקה בטכנולוגיות מתקדמות ליכולות הדרכה פרקטיות. כמפקד צוות פיתוח הדרכה ביחידת חושן, אני מתמחה בהובלת פרויקטים מורכבים, יצירת תהליכי למידה אפקטיביים, ופיתוח אמצעי הדרכה חדשניים. בנוסף, עם רקע נרחב בתקשורת נתונים ותכנות, אני מביא פתרונות הדרכה דיגיטליים מתקדמים המשלבים לומדות, אתרים וכלי בינה מלאכותית מתקדמים. אני מאמין ביצירת חוויית למידה מעוררת עניין, מותאמת אישית.',
  skills: [
    { name: 'ניהול פרויקטים' },
